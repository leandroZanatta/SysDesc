package br.com.sysdesc.atualizacao.util.classes;
...
public class ImageUtil {
	...
	public static ImageIcon resize(URL source, Integer width, Integer height) throws MalformedURLException {
		...
		g2.drawImage(new ImageIcon(source).getImage(), 0, 0, width, height, null);
		g2.dispose();
