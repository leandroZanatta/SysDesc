...
public class EntradaMercadoriasTableModel extends AbstractInternalFrameTable {
    ...
    public boolean isCellEditable(int row, int column) {
        ...
        return jtableEnabled && (column == 0 || ((column == 5 || column == 6) && (this.rows.get(row).getProduto() != null)));
    }
